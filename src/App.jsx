    ...
    <div>
      ...
      <SECTION title="Medidas" icon="📐">
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(3,1fr)", gap: 12 }}>
          <INPUT label="Desarrollo lineal (incluye giros)" value={form.largo} onChange={e=>setF("largo",e.target.value)} placeholder="3.20 m" />
...
const ETAPAS_SEGUIMIENTO = [
  ...
  { key: "instalacion", label: "En instalación",    emoji: "🔧", color: "#f0a500", msg: "Vamos en camino a instalar tu proyecto." },
  { key: "entregado",   label: "Entregado",         emoji: "🎉", color: "#4caf50", msg: "¡Proyecto entregado! Gracias por tu confianza. 🙏" },
];
const ESTADOS_LEAD = [
...
export default function App() {
  ...
  const [filtroProyectoEtapa, setFiltroProyectoEtapa] = useState("todos");
  useEffect(() => {
...
async function guardarEdicionTaller() {
    ...
    const campos = {
      ...
      zonas_cobertura: tallerEdit.zonas_cobertura,
    };
...
<div class="fir"><div class="fi"><div style="height:50px"></div><div class="fl"></div><div class="fn">${repPresup}</div><div class="fc">${nombreTaller} · Prestador</div></div><div class="fi"><div style="height:50px"></div><div class="fl"></div><div class="fn">${f.nombre||"Cliente"}</div><div class="fc">Firma de Aprobación</div></div></div>
...
Formato: Caption completo listo para copiar y pegar.`;
  ...
  : role === "taller"
    ? [["bienvenida","Inicio"],["formulario","Formulario"],["leads","Proyectos"],["leads_portal","Leads"],["presupuesto","Cotizar"],["mi_perfil","Mi Perfil"],["ia","IA"]]
